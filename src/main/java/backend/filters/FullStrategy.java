...
public class FullStrategy implements PersonFilterStrategy {

    private final PersonRepository personRepository;

    @Override
    public boolean isApplicable(String str, Gender gender, Long uyezdId, Short from, Short to) {
        return uyezdId != null && (from != null || to != null);
    }
    ...
    public List<Person> filter(String str, Gender gender, Long uyezdId, Short from, Short to) {
        ...
        return personRepository.findAllByFirstNameStartingWithIgnoreCaseAndPlace_Volost_Uyezd_IdAndBirthDate_ExactDateBetweenOrLastNameStartingWithIgnoreCaseAndPlace_Volost_Uyezd_IdAndBirthDate_ExactDateBetweenOrderByLastName
